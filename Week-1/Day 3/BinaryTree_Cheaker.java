...
public class BinaryTree_Cheaker {
    ...
    private static boolean isBST(BinaryTreeNode x, int min, int max) {
        ...
        if (min != 0 && x.value <= min) return false;
        if (max != 0 && x.value >= max) return false;
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(BinaryTree_Cheaker.class);
